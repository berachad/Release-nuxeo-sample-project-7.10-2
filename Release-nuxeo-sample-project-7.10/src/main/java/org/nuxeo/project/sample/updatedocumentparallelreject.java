...
@Operation(id = updatedocumentparallelreject.ID, category = Constants.CAT_DOCUMENT, label = "Print Info")
public class updatedocumentparallelreject {
	...
	public static final String ID = "Document.updatedocumentparallelreject";
