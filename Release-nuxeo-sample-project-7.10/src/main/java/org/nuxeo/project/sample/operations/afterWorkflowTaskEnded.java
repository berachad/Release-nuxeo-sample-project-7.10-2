...
@Operation(id = afterWorkflowTaskEnded.ID, category = Constants.CAT_DOCUMENT, label = "Create")
public class afterWorkflowTaskEnded {
	public static final String ID = "Document.afterWorkflowTaskEnded";
	...
	System.out.println("---------------------- afterWorkflowTaskEnded-----------------------");
