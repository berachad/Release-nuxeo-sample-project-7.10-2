...
@Operation(id = updatestatusparallelreject.ID, category = Constants.CAT_DOCUMENT, label = "Print Info")
public class updatestatusparallelreject {
	...
	public static final String ID = "Document.updatestatusparallelreject";
	...
	public void run() throws OperationException 
	{
		...
		{
			System.out.println("Je suis la : Statut rejete 5");
			...
			{   
				...
				{  
				    ...
				    if(champ[0].equals(currentUser))
				    {
				    	participants = participants + champ[0] + ": Test;";
				    }
				    else
				    {
				    	participants = participants + champ[0] + ":" + champ[1] + ";";
