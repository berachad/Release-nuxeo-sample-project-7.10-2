...
@Operation(id = afterWorkflowStarted.ID, category = Constants.CAT_DOCUMENT, label = "Create")
public class afterWorkflowStarted {
	public static final String ID = "Document.afterWorkflowStarted";
	...
	System.out.println("---------------------- afterWorkflowStarted-----------------------");
